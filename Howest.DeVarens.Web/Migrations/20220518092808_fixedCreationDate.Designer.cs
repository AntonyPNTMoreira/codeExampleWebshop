...
namespace Howest.DeVarens.Web.Migrations
{
    ...
    [Migration("20220518092808_fixedCreationDate")]
    partial class fixedCreationDate
    {
            ...
            modelBuilder.Entity("Howest.DeVarens.Core.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3534),
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3569),
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3572),
            ...
            modelBuilder.Entity("Howest.DeVarens.Core.Entities.FormOfEducation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000001"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3678),
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000002"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3682),
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000003"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3685),
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3689),
            ...
            modelBuilder.Entity("Howest.DeVarens.Core.Entities.Media", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000001"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3736),
                            Path = "ironman.png",
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000002"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3740),
                            Path = "dinosaurus.jpg",
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000003"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3744),
                            Path = "hout.jpg",
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000004"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3747),
                            Path = "hout2.jpg",
                            ProductId = new Guid("00000000-0000-0000-0000-000000000003"),
                            Title = "Hout"
                        },
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3751),
                            Path = "schilderij.jpg",
            ...
            modelBuilder.Entity("Howest.DeVarens.Core.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000001"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3815),
                            IsOpen = true
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000002"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3822),
                            IsOpen = false,
            ...
            modelBuilder.Entity("Howest.DeVarens.Core.Entities.OrderItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000001"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3839),
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000002"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3844),
                            OrderId = new Guid("00000000-0000-0000-0000-000000000001"),
                            ProductId = new Guid("00000000-0000-0000-0000-000000000002"),
                            ProductPrice = 79.99m,
                            Quantity = 3
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000003"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3849),
            ...
            modelBuilder.Entity("Howest.DeVarens.Core.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3708),
                        ...
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000002"),
                            CategoryId = new Guid("00000000-0000-0000-0000-000000000003"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3713),
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3717),
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 5, 18, 11, 28, 8, 372, DateTimeKind.Local).AddTicks(3720),
