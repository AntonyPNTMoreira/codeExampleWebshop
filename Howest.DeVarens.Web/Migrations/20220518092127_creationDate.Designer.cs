...
namespace Howest.DeVarens.Web.Migrations
{
    ...
    [Migration("20220518092127_creationDate")]
            ...
            modelBuilder.Entity("Howest.DeVarens.Core.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 5, 18, 11, 21, 26, 706, DateTimeKind.Local).AddTicks(2534),
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 5, 18, 11, 21, 26, 706, DateTimeKind.Local).AddTicks(2569),
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 5, 18, 11, 21, 26, 706, DateTimeKind.Local).AddTicks(2572),
            ...
            modelBuilder.Entity("Howest.DeVarens.Core.Entities.FormOfEducation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000001"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 21, 26, 706, DateTimeKind.Local).AddTicks(2685),
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000002"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 21, 26, 706, DateTimeKind.Local).AddTicks(2691),
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000003"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 21, 26, 706, DateTimeKind.Local).AddTicks(2694),
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 5, 18, 11, 21, 26, 706, DateTimeKind.Local).AddTicks(2698),
            ...
            modelBuilder.Entity("Howest.DeVarens.Core.Entities.Media", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000001"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 21, 26, 706, DateTimeKind.Local).AddTicks(2747),
                            Path = "ironman.png",
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000002"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 21, 26, 706, DateTimeKind.Local).AddTicks(2752),
                            Path = "dinosaurus.jpg",
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000003"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 21, 26, 706, DateTimeKind.Local).AddTicks(2756),
                            Path = "hout.jpg",
                        ...
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000004"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 21, 26, 706, DateTimeKind.Local).AddTicks(2759),
                            Path = "hout2.jpg",
                            ProductId = new Guid("00000000-0000-0000-0000-000000000003"),
                            Title = "Hout"
                        },
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 5, 18, 11, 21, 26, 706, DateTimeKind.Local).AddTicks(2764),
                            Path = "schilderij.jpg",
            ...
            modelBuilder.Entity("Howest.DeVarens.Core.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 5, 18, 11, 21, 26, 706, DateTimeKind.Local).AddTicks(2717),
                        ...
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000002"),
                            CategoryId = new Guid("00000000-0000-0000-0000-000000000003"),
                            CreationDate = new DateTime(2022, 5, 18, 11, 21, 26, 706, DateTimeKind.Local).AddTicks(2722),
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 5, 18, 11, 21, 26, 706, DateTimeKind.Local).AddTicks(2726),
                        ...
                        new
                        {
                            ...
                            CreationDate = new DateTime(2022, 5, 18, 11, 21, 26, 706, DateTimeKind.Local).AddTicks(2730),
